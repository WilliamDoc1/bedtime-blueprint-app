...
const EnvironmentChecklist = () => {
  return (
    <div className="content-wrapper p-6 md:p-8 max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold text-center mb-6 text-gray-900">Sleep Environment & Routine Setup Checklist</h1>
      <p className="text-center text-gray-600 mb-8">Goal: Create a space that supports calm, predictable sleep.</p>

      <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 mb-8">
        <h2 className="text-xl font-semibold mb-4 text-gray-900">Room Environment</h2>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
        <h2 className="text-xl font-semibold mb-4 text-gray-900">Evening Routine Setup</h2>
        <ul className="list-none space-y-3 text-base">
