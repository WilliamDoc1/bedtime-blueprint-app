...
const BedtimeScripts = () => {
  return (
    <div className="content-wrapper p-6 md:p-8">
      <h1 className="text-3xl font-bold mb-6 text-gray-900">Bedtime & Night-Waking Scripts Template</h1>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          <h2 className="text-xl font-semibold mb-3 text-gray-900 border-b pb-2">Pre-Bed Connection Script</h2>
          ...
          <h2 className="text-xl font-semibold mb-3 text-gray-900 border-b pb-2">Lights-Out Script</h2>
          <ul className="list-disc list-inside space-y-2 ml-4 text-sm mb-6">
        ...
        <div>
          <h2 className="text-xl font-semibold mb-3 text-gray-900 border-b pb-2">Night-Waking Script</h2>
          <ul className="list-disc list-inside space-y-2 ml-4 text-sm mb-6">
