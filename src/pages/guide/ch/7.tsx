...
const Chapter7 = () => {
  return (
    <div className="chapter-content-wrapper p-6 md:p-8">
      <h1 className="text-3xl font-bold text-center mb-6 text-gray-900">CHOOSE YOUR METHOD (3 APPROACHES)</h1>

      <div className="grid md:grid-cols-2 gap-8">
        
        {/* Column 1 */}
        <div>
          <h2 className="text-xl font-semibold mb-3 text-gray-900">WHY METHOD MATTERS</h2>
          ...
          <h2 className="text-xl font-semibold mb-3 text-gray-900">1. THE GENTLE FADING METHOD</h2>
          ...
          <h2 className="text-xl font-semibold mb-3 text-gray-900">2. THE SPACED REASSURANCE METHOD</h2>
        ...
        <div>
          ...
          <h2 className="text-xl font-semibold mb-3 text-gray-900">3. THE CHAIR METHOD</h2>
          ...
          <h2 className="text-xl font-semibold mb-3 text-gray-900">4. CHOOSING WHAT FITS</h2>
          ...
          <h2 className="text-xl font-semibold mb-3 text-gray-900">5. THE TRANSITION PLAN</h2>
