      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <ul className="list-disc list-inside space-y-1 ml-4 text-sm">
            ...
            <li>Evening: switch to amber or dim lamps 45 minutes before bed.</li>
            <li>Night: use total darkness or a single soft nightlight away from the bed.</li>
          </ul>
          ...
          <ul className="list-disc list-inside space-y-1 ml-4 text-sm">
            ...
            <li>Silence: For some children, silence feels unsafe; gentle sound builds security.</li>
          </ul>
