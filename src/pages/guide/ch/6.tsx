...
const Chapter6 = () => {
  return (
    <div className="chapter-content-wrapper p-6 md:p-8">
      <h1 className="text-3xl font-bold text-center mb-6 text-gray-900">BEDTIME ROUTINES AND EMOTIONAL COACHING</h1>

      <div className="grid md:grid-cols-2 gap-8">
        
        {/* Column 1 */}
        <div>
          <h2 className="text-xl font-semibold mb-3 text-gray-900">WHY WORDS MATTER AT BEDTIME</h2>
          ...
          <h2 className="text-xl font-semibold mb-3 text-gray-900">1. THE ROLE OF EMOTIONAL COACHING</h2>
          ...
          <h2 className="text-xl font-semibold mb-3 text-gray-900">2. SETTING GENTLE, FIRM BOUNDARIES</h2>
        ...
        {/* Column 2 */}
        <div>
          <h2 className="text-xl font-semibold mb-3 text-gray-900">3. SCRIPTS FOR COMMON SCENARIOS</h2>
          ...
          <h2 className="text-xl font-semibold mb-3 text-gray-900">4. PARENTAL SELF-REGULATION</h2>
          ...
          <h2 className="text-xl font-semibold mb-3 text-gray-900">5. EMOTIONAL CONNECTION RITUALS</h2>
          <ul className="list-disc list-inside space-y-2 ml-4 text-sm mb-4">
          ...
          <h2 className="text-xl font-semibold mb-3 text-gray-900">6. BEDTIME CUE SCRIPT</h2>
